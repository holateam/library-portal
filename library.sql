...
--
-- Хост: localhost
-- Время создания: Авг 23 2016 г., 19:13
...
INSERT INTO `books` (`book_id`, `title`, `author`, `description`, `year`, `cover`, `pages`, `status`, `event`) VALUES
(22, 'СИ++ И КОМПЬЮТЕРНАЯ ГРАФИКА', 'Андрей Богуславский', 'Лекции и практикум по программированию на Си++', 2003, '', 351, 0, NULL),
(23, 'Программирование на языке Go', 'Марк Саммерфильд', 'Разработка приложений XXI века', 2013, '', 580, 0, NULL),
(24, 'Flash CS5', 'Cтив Джонсон', 'Руководство разработчика', 2012, '', 560, 0, NULL),
(25, 'Толковый словарь сетевых терминов и аббревиатур', '', 'Официальное издание CISCO Systems', 2001, '', 366, 0, NULL);
